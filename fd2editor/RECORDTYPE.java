...
public enum RECORDTYPE {
    ...
    物品(NAMELIST.FD2FILE, 0x792C1, NAMELIST.ITEM, SEGTYPE.物品类型,
    ...
    商店(NAMELIST.FD2FILE, 0x7B3A4, Arrays.copyOfRange(NAMELIST.CHAPTER, 1, 22), SEGTYPE.物品, 
    ...
    法术(NAMELIST.FD2FILE, 0x7AA11, NAMELIST.MAGIC, SEGTYPE.攻击, SEGTYPE.命中率, SEGTYPE.施放范围,
            SEGTYPE.影响范围, SEGTYPE.法力消耗, SEGTYPE.作用对象),
    
    角色(NAMELIST.FD2FILE, 0x7ADB5, NAMELIST.ROLE, SEGTYPE.种族, SEGTYPE.职业, SEGTYPE.等级, SEGTYPE.生命,
    ...
    private RECORDTYPE(String fName, int fOffset, String[] nList, SEGTYPE... sList) {
        this.fileName = fName;
